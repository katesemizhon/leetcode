...
public class LicenseKey {
    ...
    static class Solution {
        public String licenseKeyFormatting(String S, int K) {
            String s = getFormatterLicense(new StringBuilder(S.toUpperCase()).reverse(), K).reverse().toString();
            s = s.startsWith("-") ? s.substring(1, s.length()) : s;
            s = s.endsWith("-") ? s.substring(0, s.length()-1) : s;
            return  s;
        }

        StringBuilder getFormatterLicense(StringBuilder str, int k) {
        ...
        StringBuilder deleteDashes(StringBuilder str) {
        ...
        StringBuilder getNextKGroup(StringBuilder str, int k) {
        ...
        String deleteDashes(String str) {
